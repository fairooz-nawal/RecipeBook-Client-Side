            ...
            <div className="hero-content flex-col lg:flex-row border-2 border-amber-300 rounded-2xl">
                ...
                <div>
                    ...
                    <div className="space-x-3">
                        <label htmlFor={`my_modal_${_id}`} className="btn btn-primary">Update</label>
...
const UpdateModal = ({ id, image, title, ingredients, instructions, cuisine, preparation, category, rating, handleSubmit }) => {
    return (<div className="modal z-5" role="dialog">
